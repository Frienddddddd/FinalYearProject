...
try:
    ...
    set_pump_frequency(ser, driver=0, frequency=400)                                    # set which driver to adjust and to what frequency (50 - 800)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(5)                                                                       # turn pump on for 10 seconds
    
    State_B()                                                                           # use turn_pump_on function
    time.sleep(5)                                                                       # turn pump on for 10 seconds
    State_A()
    time.sleep(5)
    State_B()                                                                           # use turn_pump_on function
