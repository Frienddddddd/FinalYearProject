...
try:
    ...
    set_pump_frequency(ser, driver=0, frequency=50)                                     # set which driver to adjust and to what frequency (50 - 800 Hz)
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=100)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=200)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=250)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=300)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=350)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=400)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=450)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=500)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=550)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=600)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=650)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=700)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=750)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
    ...
    set_pump_amplitude(ser, pump=3, amplitude=250)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # give time to process command
    set_pump_frequency(ser, driver=0, frequency=800)                                    # set which driver to adjust and to what frequency (50 - 800 Hz)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(10)                                                                      # turn pump on for 10 seconds
