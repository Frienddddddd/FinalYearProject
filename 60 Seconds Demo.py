...
try:
    ...
    print("Pump On 180")                                            
    set_pump_amplitude(ser, pump=3, amplitude=180)                                      # set which pump to turn on and at what amplitude (0 Vpp - 250 Vpp)
    time.sleep(0.1)                                                                     # small pause to let device settle
    set_pump_frequency(ser, driver=0, frequency=150)                                    # set which driver to adjust and to what frequency (50 - 800)
    turn_pump_on(ser, pump=3)                                                           # use turn_pump_on function
    time.sleep(60)                                                                      # turn pump on for 10 seconds
